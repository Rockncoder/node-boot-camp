...
module.exports = (server) => {
  // TODO: this isn't a good smell, we should have a better way to push routes
  ...
  server.get(routes.vehicleRoute, streamGetHandler2);
  // server.get(routes.vehiclesRoute, streamGetHandler3);
